...
import { Col, Row, Container, Modal, ModalHeader, ModalBody, ModalFooter } from 'reactstrap';
...
export default class NewIssueModal extends Component {
  constructor() {
    super();
    this.state = { apiItems: [], isModalopen: false, newInput1: "", newInput2: "", hasError: false, allerton: false };
  ...
  render() {
    return (
      ...
      { this.ShowAlert()}
        ...
        <Form>
         <ModalHeader> <Row className="justify-content-md-center ">  New Issue </Row> </ModalHeader> 
       
       <ModalBody>
       
        <Form.Group controlId="">
    <Form.Label>Title</Form.Label>
    <Form.Control type="text" placeholder="Enter title"  onChange={(e) => this.updateInput1(e)} />
 ...
 <Form.Group controlId="">
    ...
    <Form.Control as="textarea" rows="3" placeholder="Enter your comment" onChange={(e) => this.updateInput2(e)} />
  </Form.Group>
  
  </ModalBody>
 
  <ModalFooter> 
   <Button variant="danger" onClick={() => this.creatNewIssue()}> Summit new issue </Button> 
  </ModalFooter>
  </Form>
